...
void init_def_param(param_t *param)
{
	...
	param->dat[0] = MOTOR_PID_KP1;							//轮子1 P 参数
	param->dat[1] = MOTOR_PID_KI1;							//轮子1 I 参数
	param->dat[2] = MOTOR_PID_KD1;							//轮子1 D 参数

	param->dat[3] = MOTOR_PID_KP2;							//轮子2 P 参数
	param->dat[4] = MOTOR_PID_KI2;							//轮子2 I 参数
	param->dat[5] = MOTOR_PID_KD2;							//轮子2 D 参数

	param->dat[6] = MOTOR_PID_KP3;							//轮子3 P 参数
	param->dat[7] = MOTOR_PID_KI3;							//轮子3 I 参数
	param->dat[8] = MOTOR_PID_KD3;							//轮子3 D 参数

	param->dat[9] = MOTOR_PID_KP4;							//轮子4 P 参数
